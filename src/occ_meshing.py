...
if not args.load_path == "":
    ckpt_1 = torch.load(args.load_path, map_location="cpu")
...
while True:
    ...
    while head < num_samples:
        ...
        sample_subset = torch.tensor(samples[head : min(head + max_batch, num_samples), 0:3],dtype=torch.float).cuda()
